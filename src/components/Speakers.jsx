...
const days = [
  {
    ...
    speakers: [
      {
        name: 'Alex Chen',
        role: 'AI Engineer & Workshop Lead',
        image: stevenMchailImage,
      },
      {
        name: 'Sarah Kim',
        role: 'UofT CS Student & Club Organizer',
        image: jaquelinIschImage,
      },
      {
        name: 'Marcus Johnson',
        role: 'Anthropic API Specialist',
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-4 font-display text-2xl tracking-tight text-orange-900">
            Meet our expert facilitators who will guide you through hands-on
            AI development workshops and help you build amazing projects.
          </p>
        </div>
        <TabGroup
